        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, "Centene" },
                    { 15, "Highmark Group" },
                    { 14, "Independence Health Group Inc." },
                    { 13, "Molina Healthcare Inc." },
                    { 12, "CVS" },
                    { 10, "EmblemHealth" },
                    { 8, "HCSC" },
                    { 11, "Wellcare" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 15, "Colon & Rectal Surgery" },
                    { 14, "Chiropractic Medicine" },
                    { 13, "Child & Adolescent Psychiatry" },
                    { 12, "Cardiothoracic Surgery" },
                    { 11, "Cardiology" },
                    { 7, "Bariatric Medicine" },
                    { 9, "Cancer Care" },
                    { 8, "Bariatric Surgery" },
                    { 6, "Audiology - Hearing Health" },
                    { 5, "Anesthesiology" },
                    { 4, "Alternative Medicine" },
                    { 3, "Allergy & Immunology" },
                    { 2, "Addiction Psychiatry" },
                    { 1, "Addiction Medicine" },
                    { 20, "Endocrinology, Diabetes & Metabolism" },
