    ...
    public partial class migrationname : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    {1, 1, "Josh", "Robbins", 7167787419L, 8},{2, 2, "Zach", "Holt", 3619033062L, 14}, {3, 3, "Josh", "Zellner", 2452488647L, 4},{4, 4, "Devin", "Kraus", 8823701130L, 10},{5, 5, "Donald", "Mullen", 9016226625L, 4},{6, 6, "Maury", "Chitter", 2577977019L, 14},
